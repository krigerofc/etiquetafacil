...
export async function POST(req){
    try{
        ...
        console.log('testedawdwad', productsCount, labelCount, labelCount_today)
        if (productsCount == null || labelCount == null || labelCount_today == null) {
            return NextResponse.json({ message: "error in DB", success: false });
        }
